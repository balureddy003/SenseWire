...
SET DOCKER_IMAGE=sensewire/protocol-adapter-mqtt
...
:: Build the container image
    ...
    rmdir /s /q bin\Docker

    mkdir out\docker\mqttAdapter

    dotnet publish       --configuration %CONFIGURATION% --output bin\Docker

    xcopy /s bin\Docker\*       out\docker\mqttAdapter\
