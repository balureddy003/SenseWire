...
namespace Microsoft.Azure.IoTSolutions.IotHubManager.WebService
{
    public class DependencyResolution
    {
        ...
        private static void AutowireAssemblies(ContainerBuilder builder)
        {
            ...
            assembly = typeof(RecurringTasksAgent.IAgent).GetTypeInfo().Assembly;
            builder.RegisterAssemblyTypes(assembly).AsImplementedInterfaces();

            // Auto-wire IStatusUpdateAgent.DLL
            assembly = typeof(DeviceTwinUpdateAgent.IAgent).GetTypeInfo().Assembly;
            builder.RegisterAssemblyTypes(assembly).AsImplementedInterfaces();
        }
