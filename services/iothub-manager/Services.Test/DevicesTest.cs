...
namespace Services.Test
{
    public class DevicesTest
    {
        ...
        private readonly Mock<IStorageAdapterClient> client;

        public DevicesTest()
        {
            this.registryMock = new Mock<RegistryManager>();
            this.client = new Mock<IStorageAdapterClient>();
            this.devices = new Devices(registryMock.Object, this.ioTHubHostName,client.Object);
        }
