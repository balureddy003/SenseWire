...
namespace Microsoft.Azure.IoTSolutions.IotHubManager.Services.Models
{
    public class JobServiceModel
    {
        ...
        public IEnumerable<DeviceJobServiceModel> Devices { get; set; }
        ...
        public JobServiceModel(JobServiceModel jobResponse, IEnumerable<DeviceJob> deviceJobs = null)
        {
            this.JobId = jobResponse.JobId;
            this.QueryCondition = jobResponse.QueryCondition;
            this.CreatedTimeUtc = jobResponse.CreatedTimeUtc;
            ...
            if (jobResponse.MethodParameter != null)
            {
                this.MethodParameter =jobResponse.MethodParameter;
            }

            if (jobResponse.UpdateTwin != null)
            {
                this.UpdateTwin = jobResponse.UpdateTwin;
            }

            this.FailureReason = jobResponse.FailureReason;
            this.StatusMessage = jobResponse.StatusMessage;

            if (jobResponse.ResultStatistics != null)
            {
                this.ResultStatistics = jobResponse.ResultStatistics;
            }
