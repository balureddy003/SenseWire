...
namespace Microsoft.Azure.IoTSolutions.StorageAdapter.WebService
{
    public class DependencyResolution
    {
        ...
        private static void SetupCustomRules(ContainerBuilder builder)
        {
            ...
            builder.RegisterType<MongoDbKeyValueContainer>().As<IKeyValueContainer>().SingleInstance();
            builder.RegisterType<MongoClientFactory>().As<IFactory<IMongoClient>>().SingleInstance();
