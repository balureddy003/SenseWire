...
namespace Microsoft.Azure.IoTSolutions.StorageAdapter.WebService.Runtime
{
    ...
    public class Config : IConfig
    {
        ...
        private const string MONGO_DB_CONNECTION_STRING = APPLICATION_KEY + "mongodb_connstring";
        /// <summary>Web service listening port</summary>
        public int Port { get; }
        ...
        public Config(IConfigData configData)
        {
            ...
            this.ServicesConfig = new ServicesConfig
            {
                ...
                MongoDbConnectionString=configData.GetString(MONGO_DB_CONNECTION_STRING)
            };
        }
    }
}
