    ...
    public class AlarmsTest
    {
        ...
        */
        ...
        public async Task ThrowsOnInvalidInput()
        {
            ...
            await Assert.ThrowsAsync<InvalidInputException>(() => this.alarms.List(null, null, xssString, 0, 1, xssList.ToArray()));
            await Assert.ThrowsAsync<InvalidInputException>(() => this.alarms.ListByRule(xssString, DateTimeOffset.MaxValue, DateTimeOffset.MaxValue, xssString, 0, 1, xssList.ToArray()));
        }
    }
}
