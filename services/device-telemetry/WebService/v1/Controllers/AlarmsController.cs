...
namespace Microsoft.Azure.IoTSolutions.DeviceTelemetry.WebService.v1.Controllers
{
    ...
    public class AlarmsController : Controller
    {
        ...
        [Authorize("ReadAll")]
        public async Task<AlarmListApiModel> List(
            ...
            [FromQuery] string devices)
        {
            ...
            return await this.ListHelper(from, to, order, skip, limit, deviceIds);
        }

        [HttpPost(Version.PATH + "/[controller]")]
        [Authorize("ReadAll")]
        public async Task<AlarmListApiModel> Post([FromBody] QueryApiModel body)
        {
        ...
        private async Task<AlarmListApiModel> ListHelper(
            string from,
            string to,
            string order,
            int? skip,
            ...
            string[] deviceIds)
        {
            ...
            List<Alarm> alarmsList =await this.alarmService.List(
                fromDate,
                toDate,
                order,
                skip.Value,
